      ...
      <Box sx={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "24px 40px" }}>
        ...
        <Box>
          ...
          <Box onClick={() => logoInputRef.current?.click()} sx={{
            ...
            {logoPreview
              ? <img src={logoPreview} alt={t("settings.ceo.general.generalContent.logo")} style={{ width: "100%", height: "100%", objectFit: "contain" }} />
              : <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center", color: "#9ca3af" }}>
                  <FiUpload size={28} />
                  <Typography variant="caption" sx={{ mt: 1 }}>{t("settings.ceo.general.generalContent.uploadLogo")}</Typography>
                </Box>
            }
          </Box>
          ...
          <Box sx={{ mt: 4 }}>
            ...
            <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
              <Button variant="contained" size="small" onClick={() => ofertaInputRef.current?.click()}
                ...
                {t("settings.ceo.general.generalContent.selectFile")}
              </Button>
